          ...
          <div class="col-md d-flex justify-content-center counter-wrap ftco-animate" style="margin-right:20px;">
            <div class="block-18 color-1 align-items-stretch">
              <div class="text">
              	...
              	<h3 class="mb-4">NGO Approval</h3>
              </div>
              	<p>Grant approval </p>
              	<p><a href="#" class="btn btn-white px-3 py-2 mt-2">Click to Approve</a></p>
              </div>
            </div>
          </div>
            ...
            <div class="block-18 color-2 align-items-stretch">
              <div class="text">
                <div style="height:70px;">
              	...
              	<h3 class="mb-4">Manage Funds</h3>
              	</div>
              	<p>Management of fund</p>
              	<p><a href="#" class="btn btn-white px-3 py-2 mt-2">Manage</a></p>
              </div>
            </div>
          </div>
          <div class="col-md d-flex justify-content-center counter-wrap ftco-animate" style="margin-right:20px;">
            <div class="block-18 color-3 align-items-stretch">
          	...
          	<div style="height:70px;">
              	...
              	<p>Record of donation </p>
              	<p><a href="#" class="btn btn-white px-3 py-2 mt-2">Check Records</a></p>
              </div>
            </div>
          </div>
          ...
          <div class="col-md d-flex justify-content-center counter-wrap ftco-animate">
            <div class="block-18 color-2 align-items-stretch">
          	...
          	<div style="height:70px;">
              	...
              	<p>Updates in the website</p>
              	<p><a href="#" class="btn btn-white px-3 py-2 mt-2">Update</a></p>
              </div>
            </div>
          </div>
